...
public class PoiController {
    ...
    @ResponseBody
    public PointOfInterest addPoi(@RequestBody PointOfInterest pointOfInterest) {
    ...
    public PointOfInterest getPoiById(@PathVariable(value = "id") long id){
        return pointOfInterestService.getPointOfInterestById(id);
    }

    @ResponseBody
    @RequestMapping(value = "/get/all", method = RequestMethod.GET, produces = "application/json;charset=utf-8")
    public List<PointOfInterest> getAllCats(){
        return pointOfInterestService.getAllPointOfInterest();
    }

    @ResponseBody
    @RequestMapping(value = "/update", method = RequestMethod.PUT, produces = "application/json;charset=utf-8")
    public PointOfInterest updatePoi(@RequestBody PointOfInterest pointOfInterest){
        return pointOfInterestService.updatePointOfInterest(pointOfInterest);
    }

    @ResponseBody
    @RequestMapping(value = "/delete/{id}", method = RequestMethod.DELETE, produces = "application/json;charset=utf-8")
    public PointOfInterest deleteCat(@PathVariable(value = "id") long id){
